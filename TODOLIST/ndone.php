    ...
    <div id="main">
						...
						<!-- Post -->
							<article class="post">
							 ...
							 <h2>List Of Pending</h2> <h1>(View Data)</h1>
							...
							-->
								...
								<table class="alt">
											...
											<?php
												...
												$Maker = $_SESSION["C_ID"];
												if($re=="pri"){
													$result=mysql_query("SELECT * FROM `list` WHERE `done` = 'Pending' && `EmployeeNo` = '$Maker' ORDER BY priority DESC  ");
						...
						<!-- Post -->
							<div align="center">
								...
								<center>
								<?php
								echo" <li><a href='ndone.php?query=pri#' class='button big'>Priority</a></li>";
